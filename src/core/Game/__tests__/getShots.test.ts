...
import { CoordinateShot, TYPE_COORDINATE } from '../domain/entity/coordinate';
...
describe('Scenario: During the game, when I am a player, I want to see my previously shots', () => {
  it('should return all my shots information', async () => {
    // Arrange
    const waterShot = new CoordinateShot(5, 5, TYPE_COORDINATE.WATER);
    const touchedShot = new CoordinateShot(5, 6, TYPE_COORDINATE.TOUCHED);
